...
def add_user_dialog():
    ...
    with ui.dialog() as dialog, ui.card().classes('q-pa-md').style(f'background: {THEME["bg_panel"]}; border: 1px solid {THEME["border"]}'):
...
def render_page():
    ...
    with ui.column().classes('w-full h-screen q-pa-lg gap-6'):
        ...
        with ui.row().classes('w-full col-grow gap-6 no-wrap wrap-mobile'):
            ...
            with ui.card().classes('col-grow no-shadow column min-w-[300px]').style(f'background: {THEME["bg_panel"]}; border: 1px solid {THEME["border"]}'):
            ...
            with ui.column().classes('w-full md:w-1/3 gap-4'):
                ...
                with ui.card().classes('w-full col-grow no-shadow q-pa-md scroll').style(f'background: {THEME["bg_panel"]}; border: 1px solid {THEME["border"]}'):
                ...
                with ui.card().classes('w-full no-shadow q-pa-md').style(f'background: {THEME["bg_input"]}; border: 1px solid {THEME["border"]}'):
